<template>
  <div class="app-container">
    ...
    <span style="font-weight:bold">数据质控配置</span>
    <el-divider />
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain size="mini" @click="handleAdd">创建数据质控配置
        </el-button>
      </el-col>
      <!-- <el-col :span="1.5">
          <el-button
