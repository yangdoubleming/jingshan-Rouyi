    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column v-if="columns[1].visible" key="nickName" label="姓名" align="center" prop="nickName" :show-overflow-tooltip="true" />
          ...
          <el-table-column v-if="columns[5].visible" key="email" label="邮箱" align="center" prop="email" width="120" />
